...
class GetBEVMask(object):
    ...
    def plot_gt_boxes_mask(self, gt_boxes):
        ...
        canvas_resize = cv2.resize(canvas_temp, (640, 640))
        # 查找Counter
        ret, thresh = cv2.threshold(canvas_temp, 0, 255, 0)
        ...
        for contour in contours:
            ...
            cv2.polylines(black_image, [box_origin], isClosed=True, color=(0, 255, 0), thickness=2)
