...
from rcdfnet.core import VoxelGenerator
from rcdfnet.core.bbox import (CameraInstance3DBoxes, DepthInstance3DBoxes,
...
class PointSample(object):
    ...
    def __call__(self, results):
        ...
        if self.sample_range is not None:
            from rcdfnet.core.points import CameraPoints
