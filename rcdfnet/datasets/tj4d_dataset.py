...
class TJ4DDataset(Custom3DDataset):
    ...
    def evaluate(self,
        ...
        from rcdfnet.core.evaluation import tj4d_eval
        ...
        if isinstance(result_files, dict):
            ...
            if metric == 'img_bbox':
                ap_result_str, ap_dict = tj4d_eval(
                    gt_annos, result_files, self.CLASSES, eval_types=['bbox'])
            else:
                ap_result_str, ap_dict = tj4d_eval(gt_annos, result_files,
                                                    self.CLASSES)
            print_log('\n' + ap_result_str, logger=logger)
        ...
        for i, result in enumerate(results):
            ...
            if self.modality['use_camera'] and 'lidar2img' in img_metas.keys():
                ...
                show_multi_modality_result_my(
                    ...
                    box_mode='lidar',
                    show=show,
                    pred_bbox_color= [(241, 0, 72), (125, 0, 255), (255, 255, 0), (19, 137, 255)]
                )
