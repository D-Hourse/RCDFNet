...
from rcdfnet.ops.sst import flat2window_v2, window2flat_v2
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, d_model, nhead, dropout, batch_first=False, layer_id=None, layer_cfg=dict()):
        ...
        if layer_cfg.get('cosine', False):
            from rcdfnet.models.sst.cosine_msa import CosineMultiheadAttention
            ...
            from rcdfnet.models.sst.linear_msa import LinearMultiheadAttention
