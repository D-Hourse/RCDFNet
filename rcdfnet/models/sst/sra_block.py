...
from rcdfnet.ops.sst import flat2window, window2flat, SRATensor, DebugSRATensor, spconv
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, d_model, nhead, dropout, batch_first=False, layer_id=None):
        ...
        # from rcdfnet.models.transformer.my_multi_head_attention import MyMultiheadAttention
