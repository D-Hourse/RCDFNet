...
from rcdfnet.core import (circle_nms, draw_heatmap_gaussian, gaussian_radius,
                          xywhr2xyxyr)
from rcdfnet.models import builder
from rcdfnet.models.builder import HEADS, build_loss
from rcdfnet.models.utils import clip_sigmoid
from rcdfnet.ops.iou3d.iou3d_utils import nms_gpu
...
@HEADS.register_module()
class My_CenterHead(BaseModule):
    ...
    def __init__(self,
        ...
        assert init_cfg is None, 'To prevent abnormal initialization ' \
            'behavior, init_cfg is not allowed to be set'
        super(My_CenterHead, self).__init__(init_cfg=init_cfg)
