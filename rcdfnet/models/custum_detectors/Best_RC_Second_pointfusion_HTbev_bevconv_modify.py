...
class Best_RC_Second_pointfusion_HTbev_bevconv_modify(MVXFasterRCNN):
    """Multi-modality BEVFusion using Faster R-CNN."""

    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True,isfusion_img_index=1,
        ...
        super(Best_RC_Second_pointfusion_HTbev_bevconv_modify, self).__init__(**kwargs)
