...
class Best_RCFusion_LSS_OFT_all_convatt(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True,
        ...
        """
        super(Best_RCFusion_LSS_OFT_all_convatt, self).__init__(**kwargs)
        ...
        if rc_fusion == "concat":  ##融合层
            ...
            #     act_cfg=dict(type='ReLU'),
            #     inplace=False)
            self.cross_attention_lss = Cross_Modal_Fusion(kernel_size=3)
            self.cross_attention_oft = Cross_Modal_Fusion(kernel_size=3)
            self.cross_attention_radar = Cross_Modal_Fusion_test(kernel_size=3)
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        if self.lift:
            ...
            img_bev_feat_lss = self.cross_attention_lss(img_bev_feat_S_scale, pts_feats[0])
            img_bev_feat_oft = self.cross_attention_oft(img_bev_feat_L_scale, pts_feats[0])
            pts_feats = [self.cross_attention_radar(img_bev_feat_lss, img_bev_feat_oft)]
