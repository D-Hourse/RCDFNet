...
class RC_backbone_base(Base3DDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(RC_backbone_base, self).__init__(init_cfg=init_cfg)
    ...
    def with_bev_backbone(self):
        """bool: Whether the detector has a bev backbone in fuser detector branch."""
    ...
    def with_bev_neck(self):
        """bool: Whether the detector has a bev neck in fuser branch."""
    ...
    def simple_test_pts(self, x, img_metas, rescale=False):
        ...
        #     *outs, img_metas, rescale=rescale)            3DAnchorbox
        bbox_list = self.pts_bbox_head.get_bboxes(
            outs, img_metas, None, rescale)                               # Centerheads
        bbox_results = [
