...
class Best_RCFusion_LSS_OFT_pointFusion_sparse(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True,
        ...
        super(Best_RCFusion_LSS_OFT_pointFusion_sparse, self).__init__(**kwargs)
        ...
        if camera_stream:
            ...
            if point_fusion_config is not None:
                self.point_Fusion = PointFusion_sparse(**point_fusion_config)
