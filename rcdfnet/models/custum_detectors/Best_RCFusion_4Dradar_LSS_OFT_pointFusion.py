...
class Best_RCFusion_4Dradar_LSS_OFT_pointFusion(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True,
        ...
        super(Best_RCFusion_4Dradar_LSS_OFT_pointFusion, self).__init__(**kwargs)
