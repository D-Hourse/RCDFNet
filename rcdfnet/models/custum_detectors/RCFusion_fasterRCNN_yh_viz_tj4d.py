...
class RCFusion_FasterRCNN_yh_viz_tj4d(MVXFasterRCNN):
    ...
    def __init__(self,img_bev_harf=False, rc_fusion="concat", camera_stream=True,
        ...
        """
        super(RCFusion_FasterRCNN_yh_viz_tj4d, self).__init__(**kwargs)
        ...
        self.xlim, self.ylim = [0, 69.12], [-39.68, 39.68]
        ####-----------LSS分支初始化--------
        if camera_stream:
    ...
    def simple_test(self, points, img_metas, img=None, rescale=False, gt_bboxes_3d=None, gt_labels_3d=None):
        ...
        if pts_feats and self.with_pts_bbox:
            ...
            self.draw_gt_pred_figures_3d(points, img, gt_bboxes_3d[0], gt_labels_3d[0], img_metas, output_pts)
