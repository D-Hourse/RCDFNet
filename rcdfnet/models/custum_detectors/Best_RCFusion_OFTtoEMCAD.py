...
from .OFTNet import OftNet, OftNet_EMCAD
...
from .other_modules import PointFusion, PointFusion_sparse
...
class Best_RCFusion_OFTtoEMCAD(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True,
        ...
        super(Best_RCFusion_OFTtoEMCAD, self).__init__(**kwargs)
        ...
        if camera_stream:
            # OFT 3 ceng
            self.oft_BEVencoder = OftNet_EMCAD(img_bev_harf=img_bev_harf, grid_size=grid_size, grid_offset=grid_offset,
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        pts_feats = self.extract_pts_feat(points, img_feats, img_metas)  # 点云特征ortho  ###(B, 384, 124, 108)
