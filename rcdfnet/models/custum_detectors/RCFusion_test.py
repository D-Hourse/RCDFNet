...
class Best_RCFusion_FasterRCNN(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True,
        ...
        """
        super(Best_RCFusion_FasterRCNN, self).__init__(**kwargs)
        ...
        if camera_stream:
            ...
            self.bev_attention = nn.Sequential(
                nn.Conv2d(imc*2,
                          imc,
                          kernel_size=1,
                          stride=1,
        ...
        if rc_fusion == "concat":  ##融合层
            ...
            # self.cross_attention = BEVFuser(bev1_dims=256, bev2_dims=384, embed_dims=256,num_layers=6, num_heads=4, bev_shape=(160, 160))
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        if self.lift:
            ...
            img_bev_feat = self.bev_attention(torch.cat([img_bev_feat_L_scale, img_bev_feat_S_scale], dim=1))
