...
class Best_camera_centerhead(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, img_bev_harf=False, rc_fusion="concat", camera_stream=True, segmentation=False,
        ...
        super(Best_camera_centerhead, self).__init__(**kwargs)
        ...
        if camera_stream:
            ...
            self.bev_attention = BEVFuser(bev1_dims=256, bev2_dims=256, embed_dims=256, num_layers=4, num_heads=4,
                                          bev_shape=(160, 160))
            self.bev_conv = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=2, padding=1)
