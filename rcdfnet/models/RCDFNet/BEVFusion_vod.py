...
class BEVFusion_vod(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, camera_stream=True, isfusion_img_index=1,
        ...
        super(BEVFusion_vod, self).__init__(**kwargs)
    ...
    def simple_test(self, points, img_metas, img_inputs=None, rescale=False, gt_bev_mask=None):
