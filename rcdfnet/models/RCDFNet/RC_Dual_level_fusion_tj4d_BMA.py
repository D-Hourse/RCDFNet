...
class RC_Dual_level_fusion_tj4d_BMA(MVXFasterRCNN):
    ...
    def __init__(self,image_size=None, camera_stream=True, isfusion_img_index=1,
        ...
        super(RC_Dual_level_fusion_tj4d_BMA, self).__init__(**kwargs)
        ...
        if self.rc_fusion == "concat":  ##融合层
            ...
            self.cross_attention = Transformer_cross_attention(input_dim=80, output_dim=256, num_heads=8, qkv_bias=True,
                                                               attn_drop=0., proj_drop=0., )
        elif self.rc_fusion == "deformable_attention":
            self.cross_attention = BEVFuser(bev1_dims=80, bev2_dims=80, embed_dims=256,
                                            num_layers=4, num_heads=4, bev_shape=(self.bev_h, self.bev_w))
        else:
    ...
    def extract_pts_feat(self, pts, img_feats, img_metas):
        ...
        if self.pts_pred_context is not None:
    ...
    def extract_feat(self, points, img_inputs, img_metas):
        ...
        if self.lift:
            ...
            # bev conv
            if self.img_bev_encoder_backbone and self.img_bev_encoder_neck:
