...
model = dict(
    type='RC_Dual_level_fusion_tj4d_BMA',
    image_size=[ori_image, img_scale_flip],
    freeze_img=True,
    freeze_radar=False,
    camera_stream=True,
    grid_size=(79.36, 69.12),
    grid_res=0.32,
    ...
    bev_cross_fusion=dict(
        type='cross_attention_old'
    ),
    bev_fusion_mask_att=dict(
        in_channels=256,
...
train_pipeline = [
    ...
    dict(type='GetBEVMask', point_cloud_range=point_cloud_range, voxel_size=[0.32,0.32,6], downsample_ratio=1.),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            ann_file=
            '/mnt/data1/chengpeifeng/tj4d/datasets/TJ4DRadSet_4DRadar_infos_train.pkl',
            split='training',
            pts_prefix='velodyne',
    ...
    val=dict(
        type='TJ4DDataset',
        data_root=data_root,
        ann_file='/mnt/data1/chengpeifeng/tj4d/datasets/TJ4DRadSet_4DRadar_infos_val.pkl',
        split='training',
        pts_prefix='velodyne',
...
work_dir = './work_dirs/RCDBF_tj4d_BMA_without_bevencoder'
resume_from = None
...
load_radar_from = 'checkpoint/Pretrain/RadarPillarNet_tj4d.pth'
gpu_ids = range(0, 1)
