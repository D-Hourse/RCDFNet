# 4DRCDBF
**4DRCDBF: 4-D Radar and Camera Dual-Level-BEV Fusion for 3D Object Detection**
...
This repository is an official implementation of [4DRCDBF], our novel 4D radar-camera fusion architecture for 3D perception. 
...
|  4DRCDBF |   R50    |    56.66    |    70.61     | [config](x) | [model](x.pth) |
...
|  4DRCDBF |   R50    |    37.93    |    45.61     | [config](x) | [model](x.pth) |
...
- [RCBEVDet](https://github.com/VDIGPKU/RCBEVDet?tab=readme-ov-file), [FB-BEV](https://github.com/NVlabs/FB-BEV) , [CRN](https://github.com/youngskkim/CRN)