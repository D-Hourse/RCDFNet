...
This repository is an official implementation of [RCDFNet], our novel 4D radar-camera fusion architecture for 3D perception. 
...
|  RCDFNet |   R50    |    56.66    |    70.61     | [config](x) | [model](x.pth) |
...
|  RCDFNet |   R50    |    37.93    |    45.61     | [config](x) | [model](x.pth) |
